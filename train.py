...
# 数据处理(图片转为向量)
# 本地数据文件路径：
# 训练集-YES：/Users/lizejian/Documents/signal_machine_learning/code/data/train/YES/1.png, 2.png, .... 
# 训练集-NO：/Users/lizejian/Documents/signal_machine_learning/code/data/train/NO/1.png, 2.png, .... 
# 测试集-YES：/Users/lizejian/Documents/signal_machine_learning/code/data/test/YES/1.png, 2.png, ....
# 测试集-NO：/Users/lizejian/Documents/signal_machine_learning/code/data/test/NO/1.png, 2.png, ....
# 训练代码所在路径：code/train.py

# 本地数据文件路径
train_yes_dir = '/Users/lizejian/Documents/signal_machine_learning/code/data/train/YES'
train_no_dir = '/Users/lizejian/Documents/signal_machine_learning/code/data/train/NO'
test_yes_dir = '/Users/lizejian/Documents/signal_machine_learning/code/data/test/YES'
test_no_dir = '/Users/lizejian/Documents/signal_machine_learning/code/data/test/NO'
